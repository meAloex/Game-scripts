...
Terrorblade.option = Menu.AddOptionBool({"Hero Specific", "Terrorblade"}, "Terrorblade", false)
Menu.AddOptionIcon({"Hero Specific", "Terroblade"}, "panorama/images/heroes/icons/npc_dota_hero_terroblade_png.vtex_c")
Terrorblade.optionTarget = Menu.AddOptionSlider({"Hero Specific", "Terrorblade"}, "Target Radius", 200, 1000, 500)
Terrorblade.optionComboKey = Menu.AddKeyOption({"Hero Specific", "Terrorblade"}, "Combo key", Enum.ButtonCode.BUTTON_CODE_NONE)
Terrorblade.optionDiffusal  = Menu.AddOptionBool({"Hero Specific", "Terrorblade", "Items"}, "Diffusal", false)
Terrorblade.optionManta  = Menu.AddOptionBool({"Hero Specific", "Terrorblade", "Items"}, "Manta", false)
Terrorblade.optionBkb  = Menu.AddOptionBool({"Hero Specific", "Terrorblade", "Items"}, "Bkb", false)
Terrorblade.optionAutoUlt = Menu.AddOptionBool({"Hero Specific", "Terrorblade"}, "Auto ultimate", false)
Terrorblade.optionUltSlider = Menu.AddOptionSlider({"Hero Specific", "Terrorblade"}, "HP threshold", 10 ,50, 30)
